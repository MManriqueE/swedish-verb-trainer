...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-bold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-button hover:brightness-110 hover:-translate-y-0.5 hover:shadow-lift",
        destructive:
          "bg-destructive text-destructive-foreground shadow-md hover:brightness-110",
        outline:
          "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground",
        secondary:
          "bg-secondary text-secondary-foreground shadow-button-secondary hover:brightness-110 hover:-translate-y-0.5",
        ghost: 
        ...
        tense:
          "bg-card text-card-foreground border-2 border-border shadow-card hover:border-primary hover:shadow-lift hover:-translate-y-1 transition-all duration-300",
        tenseActive:
          "bg-primary text-primary-foreground border-2 border-primary shadow-button hover:-translate-y-1",
      },
      size: {
